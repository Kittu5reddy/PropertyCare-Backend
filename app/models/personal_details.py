...
class PCUser(Base):
    ...
    user_name = Column(Integer, primary_key=True, index=True)
    first_name = Column(String(100), nullable=False)
    last_name = Column(String(100), nullable=False)
    username = Column(String(8), unique=True, index=True, nullable=False)
    ...
    profile_photo_path = Column(String(255), nullable=False)
    pan_document_path = Column(String(255), nullable=False)
    aadhaar_document_path = Column(String(255), nullable=False)
