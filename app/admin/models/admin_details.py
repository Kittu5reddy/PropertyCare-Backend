...
class AdminDetails(Base):
    ...
    admin_id: Mapped[str] = mapped_column(String(50),ForeignKey("admin.admin_id"), nullable=False, unique=True )
    admin_name: Mapped[str] = mapped_column(String(50), nullable=False, unique=True, index=True)  # fixed
